      ...
      <DialogContent className="max-w-md p-0 overflow-hidden" >
        ...
        <div className="bg-[#0a0f1e] text-white p-6 text-center">
          ...
          <h2 className="text-lg font-bold tracking-wide">
            {locale === "ar" ? "استوديو فرونيسس" : "Studio of Phronesis"}
          </h2>
          <p className="text-xs text-white/60 mt-1 italic">
            {locale === "ar" ? "مشروع تجريبي" : "Demonstration Project"}
          </p>
        </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800">
            ...
            <div className="text-sm text-foreground/80 leading-relaxed">
              {locale === "ar"
                ? "هذا الموقع لأغراض العرض التوضيحي فقط. لا تقم بإدخال أي معلومات شخصية. إنه مشروع تجريبي لإظهار دقة وجودة عملنا، وسيتم مسح جميع البيانات خلال 48 ساعة من 26 يونيو 2026 الساعة 6:00 صباحاً بتوقيت الإمارات."
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                {locale === "ar" ? "الوقت المتبقي حتى المسح" : "Time Until Purge"}
              </span>
            </div>
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
            ...
            <span>
              {locale === "ar"
                ? "صُنع بدقة بواسطة استوديو فرونيسس"
                : "Crafted with precision by Studio of Phronesis"}
            </span>
          </div>
          ...
          <Button
            onClick={handleAgree}
            className="w-full bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 dark:bg-[#c9a84c] dark:hover:bg-[#c9a84c]/90 dark:text-[#0a0f1e] font-semibold py-3"
          >
            {locale === "ar" ? "أنا أوافق" : "I Agree"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
