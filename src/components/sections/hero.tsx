...
export function HeroSection() {
  ...
  const searchItem = {
    ...
    show: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] as const, delay: 0.5 } }
  }

  return (
    <section ref={heroRef} id="home" className="relative min-h-[80vh] md:min-h-[92vh] flex items-center overflow-hidden">
      <div
      ...
      >
        <div style={{ animation: prefersReducedMotion ? undefined : "kenBurns 25s ease-in-out infinite alternate" }}>
          <img
            src="/hero-image.jpg"
            alt="UAE real estate"
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle at 70% 20%, rgba(201,168,76,0.08) 0%, transparent 60%)" }}
      />

      <div className="container mx-auto px-4 relative z-10 py-16 md:py-20">
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl mx-auto text-center text-white">
          ...
          <motion.h1 variants={item} className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
            {t("home.heroTitle")}
          </motion.h1>

          <motion.p variants={item} className="text-sm md:text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            {t("home.heroSubtitle")}
          </motion.p>
