...
const TESTIMONIALS = [
  {
    ...
    textEn: "Abraj Trwada Real Estate helped me find my dream villa in Al Jimi within just two weeks. Their team was professional, responsive on WhatsApp, and genuinely understood my family's needs.",
  ...
  },
  {
    ...
    textEn: "I've worked with several agencies in Al Ain, but Abraj Trwada Real Estate stands out for their transparency and market knowledge. They've helped me acquire 3 investment properties so far.",
